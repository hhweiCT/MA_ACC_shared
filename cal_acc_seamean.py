...
## multiply the scale for precip (change units)
...
# loop though models to calculate and save ACC
for ii, Modelname in enumerate(Models_list):  
    print(Modelname)
    ...
    ds_precip_corr_30SN_ensM_OneModel_GPCPnodetrend_seaM.to_netcdf(
        ma_folder_path+'analyses/ACC/ds_precip_corr_30SN_ensM_'+Modelname+'_'+Ensembles_list[ii]+'_GPCPnodetrend_seaM.nc'
    )
    ...
    ds_precip_corr_30SN_ensM_OneModel_GPCPdetrend_seaM.to_netcdf(
        ma_folder_path+'analyses/ACC/ds_precip_corr_30SN_ensM_'+Modelname+'_'+Ensembles_list[ii]+'_GPCPdetrend_seaM.nc'
    )
